...
namespace Acuminator.Analyzers.StaticAnalysis
{
	...
	public static class Descriptors
	{
		...
		public static DiagnosticDescriptor PX1077_EventHandlersShouldBeProtectedVirtual { get; } =
			Rule("HX2002", nameof(Resources.PX1077Title).GetLocalized(), Category.Acuminator, DiagnosticSeverity.Warning, DiagnosticsShortName.HX2002,
		...
		public static DiagnosticDescriptor PX1077_EventHandlersShouldNotBePrivate { get; } =
			Rule("HX2002", nameof(Resources.PX1077Title_EventHandlersShouldNotBePrivate).GetLocalized(), Category.Acuminator, DiagnosticSeverity.Error, DiagnosticsShortName.HX2002);

		public static DiagnosticDescriptor PX1077_EventHandlersShouldNotBeExplicitInterfaceImplementations { get; } =
			Rule("HX2002", nameof(Resources.PX1077Title_ExplicitInterfaceImplementation).GetLocalized(), Category.Acuminator, DiagnosticSeverity.Error, DiagnosticsShortName.HX2002);
